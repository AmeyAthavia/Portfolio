...
const Home = () => {
  return (
    <div name="home" className='h-screen w-full bg-gradient-to-b from-blue-800 to-50% to-gray-200 from-60% lg:bg-gradient-to-r from-blue-800 to-55%
    to-white from-55% items-center'>
