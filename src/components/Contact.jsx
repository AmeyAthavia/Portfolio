...
const Contact = () => {
  return (
    <div name='contact me' className='w-full p-4 text-white h-screen bg-gradient-to-b from-blue-900 to-blue-500 lg:bg-gradient-to-r from-blue-900 to-blue-500 md:h-screen sm:h-screen'>
